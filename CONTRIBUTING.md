Contributing to OmniStoreCoin Core
============================

The OmniStoreCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OmniStoreCoin Core project, and is not to be
confused with overall OmniStoreCoin Network Protocol consensus changes.

Whether a pull request is merged into OmniStoreCoin Core rests with the project merge
...
Patches that change OmniStoreCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the OmniStoreCoin consensus, it must have been
...
The project leader is the release manager for each OmniStoreCoin Core release.
