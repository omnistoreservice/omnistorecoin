...
#   c) node1 mines 32 blocks, so now node 0 has 60001omns, node 1 has 4250omns, node2 has none.
#   d) node0 sends 601 omns to node2, in two transactions (301 omns, then 300 omns).
