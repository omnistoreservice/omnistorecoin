...
/** 
    ...
    ****Note - for OmniStoreCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of omnistorecoin coming in to a transaction
