...
#define MASTERNODE_EXPIRATION_SECONDS (40 * 60)    //120 * 60
#define MASTERNODE_REMOVAL_SECONDS (50 * 60)   //130 * 60
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 OMNS, signature to prove
