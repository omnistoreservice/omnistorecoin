...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OmniStoreCoin Core omnistorecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  omnistorecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded omnistorecoin transaction") + "\n" +
                               "  omnistorecoin-tx [options] -create [commands]   " + _("Create hex-encoded omnistorecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded omnistorecoin transaction
