                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OmniStoreCoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    connect(openOmniStoreWebsiteAction, SIGNAL(triggered()), rpcConsole, SLOT(openOmniStoreWebsite()));
    connect(openOmniStoreTwitterAction, SIGNAL(triggered()), rpcConsole, SLOT(openOmniStoreTwitter()));
    connect(openOmniStoreDiscordAction, SIGNAL(triggered()), rpcConsole, SLOT(openOmniStoreDiscord()));
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OmniStoreCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and omnistorecoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOMNS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OmniStoreCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about OmniStoreCoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for OmniStoreCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OmniStoreCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OmniStoreCoin addresses"));
    ...
    openOmniStoreWebsiteAction = new QAction(networkStyle->getAppIcon(), tr("Open OmniStore website"), this);
    openOmniStoreWebsiteAction->setStatusTip(tr("Open OmniStore website"));
    openOmniStoreTwitterAction = new QAction(networkStyle->getAppIcon(), tr("Follow OmniStore Twitter"), this);
    openOmniStoreTwitterAction->setStatusTip(tr("Follow OmniStore Twitter"));
    openOmniStoreDiscordAction = new QAction(networkStyle->getAppIcon(), tr("Join OmniStore Discord"), this);
    openOmniStoreDiscordAction->setStatusTip(tr("Join OmniStore Discord"));
    ...
    openAction->setStatusTip(tr("Open a OmniStoreCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OmniStoreCoin Core help message to get a list with possible OmniStoreCoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addSeparator();
    help->addAction(openOmniStoreWebsiteAction);
    help->addAction(openOmniStoreTwitterAction);
    help->addAction(openOmniStoreDiscordAction);
    help->addSeparator();
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OmniStoreCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::createTrayIconMenu()
{
    ...
    trayIconMenu->addSeparator();
    trayIconMenu->addAction(openOmniStoreWebsiteAction);
    trayIconMenu->addAction(openOmniStoreTwitterAction);
    trayIconMenu->addAction(openOmniStoreDiscordAction);
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OmniStoreCoin network", "", count));
}
...
{
    QString strTitle = tr("OmniStoreCoin Core"); // default title
