...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::OMNS, nValue);
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (omnistorecoin.conf).");
            QMessageBox::warning(this, "OmniStoreCoin Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#333333; bgcolor:#f8f6f6;}\n a, span { font-family: monospace; }\n span.addr {color:#333333; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #f8f6f6;}\n td.d0 {font-weight: bold; color:#333333;}\n h2, h3 { white-space:nowrap; color:#333333;}\n a { color:#1eb4d1; text-decoration:none; }\n a.nav {color:#333333;}\n";
