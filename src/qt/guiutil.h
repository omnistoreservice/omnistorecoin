...
/** Utility functions used by the OmniStoreCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render OmniStoreCoin addresses in monospace font
...
// Parse "omnistorecoin:" URI into recipient object, return true on successful parsing
