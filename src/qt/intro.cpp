...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("OmniStoreCoin Core"),
     ...
     * override -datadir in the omnistorecoin.conf file in the default data directory
     * (to be consistent with omnistorecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
