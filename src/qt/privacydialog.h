...
public:
    ...
    void setZCuxControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzOMNS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzOMNS_clicked();
    void on_pushButtonZCuxControl_clicked();
