...
public slots:
    ...
    void showRepair();
    /** Open external (default) editor with omnistorecoin.conf */
    void showConfEditor();
    ...
    void showBackups();
    /** Open OmniStore website */
    void openOmniStoreWebsite();
    /** Open OmniStore twitter */
    void openOmniStoreTwitter();
    /** Open OmniStore discord */
    void openOmniStoreDiscord();
