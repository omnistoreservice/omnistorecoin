...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop OmniStoreCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "OmniStoreCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OmniStoreCoin features */
        {"omnistorecoin", "masternode", &masternode, true, true, false},
        {"omnistorecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"omnistorecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"omnistorecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"omnistorecoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"omnistorecoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"omnistorecoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"omnistorecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"omnistorecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"omnistorecoin", "startmasternode", &startmasternode, true, true, false},
        {"omnistorecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"omnistorecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"omnistorecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"omnistorecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"omnistorecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"omnistorecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"omnistorecoin", "mnbudget", &mnbudget, true, true, false},
        {"omnistorecoin", "preparebudget", &preparebudget, true, true, false},
        {"omnistorecoin", "submitbudget", &submitbudget, true, true, false},
        {"omnistorecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"omnistorecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"omnistorecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"omnistorecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"omnistorecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"omnistorecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"omnistorecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"omnistorecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"omnistorecoin", "mnsync", &mnsync, true, true, false},
        {"omnistorecoin", "spork", &spork, true, true, false},
        {"omnistorecoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzomnsseed", &getzomnsseed, false, false, true},
        {"zerocoin", "setzomnsseed", &setzomnsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzomns", &searchdzomns, false, false, true},
        {"zerocoin", "dzomnsstate", &dzomnsstate, false, false, true}
...
{
    return "> omnistorecoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6855/\n";
}
