...
/**
 * OmniStoreCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzomnsseed(const UniValue& params, bool fHelp);
extern UniValue getzomnsseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzomns(const UniValue& params, bool fHelp);
extern UniValue dzomnsstate(const UniValue& params, bool fHelp);
